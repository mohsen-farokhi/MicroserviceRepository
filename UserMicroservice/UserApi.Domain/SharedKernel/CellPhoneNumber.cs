namespace UserApi.Domain.SharedKernel
{
		...
		Framework.Domain.SeedWork.ValueObject
	{
		...
		public static Framework.Result<CellPhoneNumber> Create(string value)
		{
			var result =
				new Framework.Result<CellPhoneNumber>();
		...
		public Framework.Result<CellPhoneNumber> Verify()
		{
			var result =
				new Framework.Result<CellPhoneNumber>();
		...
		public Framework.Result<CellPhoneNumber> VerifyByKey(string verificationKey)
		{
			var result =
				new Framework.Result<CellPhoneNumber>();
